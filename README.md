...
> 📍 **개발 현황·앞으로의 방향**은 [ROADMAP.md](ROADMAP.md)에 정리돼 있습니다.
...
- **매매 사유 태그·메모**: 거래마다 태그(계획·추격·충동·패닉·분할·리밸런싱·기타)와 메모를 남기면,
  통화별 **🧠 태그별 매매 피드백**(태그별 빈도·실현손익·승률)으로 "어떤 마음가짐의 매매가 돈을
  버는지/잃는지"를 숫자로 확인(실현손익은 매도 시점 태그 기준).
